...
for (i in 1:8) {
  left_events[i,] = c(left_list1[left_intervals[i,1]:left_intervals[i,2]]-median(left_list1),"L")
}
...
for (i in 1:10) {
  left_events[i+16,] = c(left_list3[left_intervals[i,1]:left_intervals[i,2]]-median(left_list3),"L")
}
...
```{r rightevents}
right_events = data.frame(matrix(nrow = 28, ncol = 15002))
...
for (i in 1:11) {
  right_events[i+17,] = c(right_list3[right_intervals[i,1]:right_intervals[i,2]]-median(right_list3), "R")
}
...
for (i in 1:9) {
  up_events[i,] = c(up_list1[up_intervals[i,1]:up_intervals[i,2]],"U")
}
...
for (i in 1:9) {
  up_events[i+9,] = c(up_list2[up_intervals[i,1]:up_intervals[i,2]],"U")
}
...
for (i in 1:11) {
  up_events[i+18,] = c(up_list3[up_intervals[i,1]:up_intervals[i,2]],"U")
}
...
for (i in 1:9) {
  down_events[i,] = c(down_list1[down_intervals[i,1]:down_intervals[i,2]],"D")
}
...
for (i in 1:12) {
  down_events[i+9,] = c(down_list2[down_intervals[i,1]:down_intervals[i,2]],"D")
}
...
for (i in 1:11) {
  down_events[i+21,] = c(down_list3[down_intervals[i,1]:down_intervals[i,2]],"D")
}
...
for (i in 1:13) {
  random_events[i,] = c(random_list1[random_intervals[i,1]:random_intervals[i,2]],"N")
}
...
for (i in 1:10) {
  random_events[i+13,] = c(random_list2[random_intervals[i,1]:random_intervals[i,2]],"N")
}
...
for (i in 1:9) {
  random_events[i+23,] = c(random_list4[random_intervals[i,1]:random_intervals[i,2]],"N")
}
...
for (i in 1:10) {
  random_events[i+32,] = c(random_list5[random_intervals[i,1]:random_intervals[i,2]],"N")
}
...
for (i in 1:10) {
  random_events[i+42,] = c(random_list6[random_intervals[i,1]:random_intervals[i,2]],"N")
}
...
test = rbind(left_events, right_events, up_events, down_events)
