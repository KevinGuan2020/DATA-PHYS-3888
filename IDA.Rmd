...
for (i in 1:11) {
  right_events[i+18,] = c(right_list3[right_intervals[i,1]:right_intervals[i,2]]-median(right_list3), "R")
}
...
ggplot() +
  geom_line(aes(y = up_list3-median(up_list3), x = c(1:length(up_list3))))
```
...
up_peaks = pracma::findpeaks(up_sd$sd, npeaks = 9, minpeakheight = 8 , ndown = 5, minpeakdistance = 200)[,2]
...
up_peaks = pracma::findpeaks(up_sd$sd, npeaks = 9, minpeakheight = 5 , ndown = 5, minpeakdistance = 200)[,2]
up_intervals = up_sd[up_peaks,c(1:2)]
...
up_peaks = pracma::findpeaks(up_sd$sd, npeaks = 11, minpeakheight = 5 , ndown = 5, minpeakdistance = 200)[,2]
up_intervals = up_sd[up_peaks,c(1:2)]
...
down_peaks = pracma::findpeaks(down_sd$sd, npeaks = 9, minpeakheight = 13 , ndown = 5, minpeakdistance = 200)[,2]
...
down_peaks = pracma::findpeaks(down_sd$sd, npeaks = 11, minpeakheight = 10 , ndown = 5, minpeakdistance = 150)[,2]
down_intervals = down_sd[down_peaks,c(1:2)]
down_intervals
for (i in 1:11) {
