...
```{r}
max(Classifer(left_list2-median(left_list2))$Zero)
min(Classifer(up_list1-median(up_list1))$sd)

test = left_list2-median(left_list2)
Classifer(test)
```


```{r}
Classifer(left_list2-median(left_list2))
down_intervals = Classifer(left_list2-median(left_list2))

ggplot() +
  geom_line(aes(y = left_list2-median(left_list2), x = c(1:length(left_list2)))) +
